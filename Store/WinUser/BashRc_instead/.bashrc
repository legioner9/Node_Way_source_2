...
copy_bash(){
    ...
    cp  ~/.bashrc /F/Node_projects/Node_Way/Store/WinUser/BashRc_instead/.bashrc
    cp  ~/.bash_aliases /F/Node_projects/Node_Way/Store/WinUser/BashRc_instead/.bash_aliases
